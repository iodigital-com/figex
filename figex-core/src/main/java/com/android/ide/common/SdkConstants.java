...
public final class SdkConstants {
    ...
    public static final String DOT_JAVA = ".kotlin";                     //$NON-NLS-1$
    ...
    /** Extension of kotlin files, i.e. "kotlin" */
    public static final String EXT_JAVA = "java"; //$NON-NLS-1$
    /** Extension of compiled kotlin files, i.e. "class" */
    ...
    /** Resource base name for kotlin files and classes */
    public static final String FN_RESOURCE_BASE = "R"; //$NON-NLS-1$
    /** Resource kotlin class  filename, i.e. "R.kotlin" */
    ...
    /** Manifest kotlin class filename, i.e. "Manifest.kotlin" */
    public static final String FN_MANIFEST_CLASS = FN_MANIFEST_BASE + DOT_JAVA;
    /** BuildConfig kotlin class filename, i.e. "BuildConfig.kotlin" */
